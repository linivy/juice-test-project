...
class TestActivity:
    ...
    def test_TC_001(self, page):
        ...
        page.evaluate("document.querySelector('#formDescription').innerHTML = '这是一个测试活动简介'")
    ...
    def test_TC_004(self, page):
        ...
        for option in expected_options:
            assert option in sub_type_options, f"二级下拉框应包含'{option}'选项"
    @allure.feature("创建活动")
    ...
    def test_TC_005(self, page):
        ...
        # 6. 验证二级下拉框包含预期的选项
        expect(page.locator("#formSubType")).to_contain_text("亲子活动")
        expect(page.locator("#formSubType")).to_contain_text("户外露营")
        expect(page.locator("#formSubType")).to_contain_text("亲子烘焙")
    @allure.feature("创建活动")
    ...
    def test_TC_007(self, page):
        ...
        page.evaluate("document.querySelector('#formStartTime').value = '2024-01-01 10:00';")
        page.evaluate("document.querySelector('#formEndTime').value = '2024-01-01 18:00';")
        page.evaluate("document.querySelector('#formDescription').innerHTML = '这是一个测试活动'")
    ...
    def test_TC_008(self, page):
        ...
        page.evaluate("document.querySelector('#formStartTime').value = '2024-01-01 10:00';")
        page.evaluate("document.querySelector('#formEndTime').value = '2024-01-01 18:00';")
        page.evaluate("document.querySelector('#formDescription').innerHTML = '这是一个测试线下活动的描述'")
    ...
    @allure.feature("创建活动")
    @allure.title("TC_010: 测试所有必填字段为空，点击【完成创建】，验证提示“请输入活动名称”（页面验证顺序：活动名称 → 活动类型 → 开始时间 → 结束时间 → 活动简介）")
    def test_TC_010(self, page):
        ...
        # 5. 验证提示“请输入活动名称”（页面验证顺序：活动名称 → 活动类型 → 开始时间 → 结束时间 → 活动简介）
        expect(page.locator("#toast")).to_contain_text("请输入活动名称")
        expect(page.locator("#error_formName")).to_be_visible()
    @allure.feature("创建活动")
    ...
    def test_TC_014(self, page):
        ...
        # 10. 验证活动简介字段显示错误
        # 活动简介没有独立的错误元素，跳过此断言
        expect(page.locator("#error_formDescription")).to_contain_text("请输入活动简介")
    @allure.feature("创建活动")
    ...
    @allure.feature("创建活动")
    @allure.title("TC_016: 测试填写部分信息后，点击【放弃创建】，取消放弃，验证停留在创建弹框上，已填写的信息保留")
    ...
    def test_TC_017(self, page):
        ...
        expect(page.locator("#error_formName")).to_be_visible()
    @allure.feature("创建活动")
    @allure.title("TC_018: 测试重复快速点击【完成创建】按钮，验证只弹一次确认弹框")
